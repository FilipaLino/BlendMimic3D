...
BlendMimic3D is a pioneering synthetic dataset developed using Blender, designed to enhance Human Pose Estimation (HPE) research. This dataset features diverse scenarios including self-occlusions, object-based occlusions, and out-of-frame occlusions, tailored for the development and testing of advanced HPE models. All data were extracted using our [BlendMimic3D-DataExtractor](https://github.com/FilipaLino/BlendMimic3D-DataExtractor). For more information, interactive demos, and downloads related to the BlendMimic3D project, please visit our [project webpage](https://blendmimic3d.github.io/BlendMimic3D/).
